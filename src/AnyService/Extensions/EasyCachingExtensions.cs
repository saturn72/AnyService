...
namespace EasyCaching.Core
{
    ...
    {
        public static async Task<T> GetValueOrDefaultAsync<T>(this IEasyCachingProvider cache, string cacheKey, T defaultValue = default, CancellationToken cancellationToken = default)
        {
